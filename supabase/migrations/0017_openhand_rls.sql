-- =============================================================================
-- 0017_openhand_rls.sql
--
-- Open Hand ("Ol' Man") — partner-open. Step 2 of 2: everything that reads
-- or writes the 'openhand' enum value added in 0016_openhand.sql.
--
...
comment on column public.hand_public.mode is
  ...
  'than the current table setting — see 0016/0017.';
