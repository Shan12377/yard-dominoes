...
- As of 2026-09-18, `www.yaaddominoes.com` serves commit `PENDING`
  (v212: Yard TV's occasional subscribe nudge under the play line; v211: Yard TV shows each seat's points on the table and brands the shuffle
  with the wordmark; v210: Yard TV shuffles the real 28 bones on the real felt and deals them
  round the seats, instead of the branded deal overlay; v209: the front page review is credited to Orlando by name; v208: a bone that doesn't fit no longer covers the hand (the note moved to
  the tray header, Practice and Lounge, every game), a duppy's pass shows on
  French phone tabs; v207: Top of the yard shows the single highest-rated player across all five
  ...
  five leaderboard tabs), Top of the yard on the front door; v205: French its own Yard Rating (0067 applied), French set line names the bust and ties; v204: French end-of-set names the lowest score; v203: Lounge French phone shorter hand banner, top player across the top; v202: no bone off the wood on narrow phones, thin Practice French score line; v201: Practice cut throat table 740px, bones never drop below 26px; v200: Yard TV side panel fits; v199: Yard TV big shuffle, names fit; v198: admins unranked with an Admin badge; v197: rank tiers, Table Trust, career stats, rating rules (0066 applied, six game functions redeployed); v196: left Lounge seats open to real people after 5 minutes, booked for the next deal (0065 applied); v195: Yard TV teaches all five games with shuffle, why-captions, talk and a rotating cast, secret-key link; v194: Yard TV at /showcase, a 24/7 teaching table for streaming; v193: one hand tray look everywhere (blue waiting, green + gold on turn; see design rules), pose question no longer shrinks bones; v192: Across strips get the gold turn glow; v191: Practice hand strip gold turn ring restored; v190: Night table moon switch beside the table colours; v189: Practice hand strip and frame back to signal blue; v188: Practice phone JamDom look (hand strip, framed wood); cut throat shorter table at 28px; v187: the hand after a bruk is worth 2 (engine + game functions), "This hand is worth 2" shown; v186: Practice side players show bones and points on phones, two-line layout; v185: no duppy-advance error banner for a table you are not seated at; v184: Lounge Across side players show bones and points; Across hands follow the board bone; v183: Across phones thin 64px hand strips at the rim, 28px board and hands (Lounge and Practice), Pass always visible; v182: French board pass needs the player who shut the board to be able to play again, else it is a blocked hand (engine + game functions); v181: Rejoin works on recycled join codes (join-table redeployed), Practice Across Pass visible on phones, Lounge Across 26px like Practice, French runs capped at 3, bright scores everywhere; v180: one tap selects a hand bone on iPhone (touchend), French arms turn outward when blocked and never run past 4 straight; v179: scoreboard points bone white, French hand crisp from the deal, pose hint centred; v178: French phones 24px bones, two out before each turn (980/1000 simulated hands clean); v177: French arms turn at most a U (curls only as a last resort), top player's bones hang off the top edge; v176: French board pass says who, which bone and the number nobody had (engine + game functions redeployed), side players' name/bones/points back under the face, French side bones hang off the phone edge, crisp French hand; v175: Lounge phone Across matches Practice: full-height table, 24px board, no duplicate portrait; v174: Across phone hands show real 26x52 bones (had one giant bone per strip since v167); v173: Lounge phone side faces fill their column like Practice, French tab photos back in their tabs with counts off the faces, French phone page no wider than the screen; v172: version bump that proved the update check end to end; v171: Check for updates waits for a found update before answering; v170: Lounge deals like Practice (full shuffle, nothing underneath, opening turn gets the time), Lounge side players 32x58 on phones; v169: rooms by game live (0063 applied), ranking is the Yardie/VIP perk, leaderboard shows members; v168: rooms offer only their games and create-table enforces it, one guest sign-in banner, migration 0063 written but not yet applied; v167: Across phone strips fixed size, French phone bones 26px with an edge gap, French tabs clear of my hand; v166: opening shuffle in the Lounge, open hand's partner bones at the top and identical to mine; v165: readable 42px faces on phones, partner's open hand identical to mine; v164: full-width phone tables, VIP badge, gifts at the table, spectator notice, Shuffle in quick chat, French tabs clear of each arm's turn; v163: turn strip never leaves the wood, heavier rail titles; v162: turn strip beside my hand, Lounge rail cards meet contrast in brand colours, table header names the game; v161: French bones match every other game, Lounge table colour, Across climbs three, turn info down the side, French phone centre row three each side; v160: live table stops flickering (portraits, played bones, hand bones, sticker bars and the You panel are kept across rebuilds), profile edits survive a rebuild, Lounge French phone pinwheel; v159: Lounge hands left on the results, crisp deal-check dominoes with Hide, Profile Sign out; v158: sitemap.xml; v157: /terms and /privacy addresses; v156: legal pages show no company/address placeholders, contact info@drshallandahunter.com; v155: desktop boards fill the table with bigger bones and a 4-bone centre row, never clipped; JamDom French arms on desktop; Practice pass the pose; top hand inside the table; v154: Lounge Sign in to play, one-tap Google/Apple shown when enabled in
